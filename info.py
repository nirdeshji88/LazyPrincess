...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Hd2bit_owner')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Hd2bit™](https://t.me/+jg8-fN6IdZ8wYzM1)</b>⚡\n\n🎦 <b>File Name: </b> ➥  {file_caption} \n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Hd2bit™](https://t.me/+jg8-fN6IdZ8wYzM1)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌𝐈𝐌𝐃𝐛 𝐃𝐚𝐭𝐚 𝐛𝐲 ⊶ @Hd2bit_Channel \n\n➛ ᴛɪᴛʟᴇ ⊶ <a href={url}>{title}</a>\n➛ ɢᴇɴʀᴇꜱ ⊶ {genres}\n➛ ʏᴇᴀʀ ⊶ <a href={url}/releaseinfo>{year}</a>\n➛ ʀᴀᴛɪɴɢ ⊶ <a href={url}/ratings>{rating}</a> / 10 \n\n★ Please Share Us ★\n\n▽ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ▽ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ Qᴜᴇʀʏ ᴘʀɪᴠᴀᴛᴇʟʏ")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Hd2bit_owner') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Hd2bit_Channel') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Hd2bit_Channel') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Hd2bit_Channel')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
DOWNLOAD_TEXT_URL = "https://t.me/Hd2bit_Channel"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Hd2bit_Channel"
...
# Credit @Hd2bit_Channel.
# Please Don't remove credit.
# Born to make history @Hd2bit_Channel !
# Thank you LazyDeveloper for helping us in this Journey
# 🥰  Thank you for giving me credit @Hd2bit_Channel  🥰
# for any error please contact me -> telegram@Hd2bit_Channel or insta @Hd2bit_Channel 
# rip paid developers 🤣 - >> No need to buy paid source code while @Hd2bit_Channel is here 😍😍
